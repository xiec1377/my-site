    ...
    <div className="cards-container">
      <div className="card-container">
        ...
        <p>
          <ul>
            <li>
              Updated and maintained company portal used by <b>4,000+</b> users
              a week with ReactJS and Django back-end API
            </li>{' '}
            <li>
            ...
            <li>
              ...
              wireframing and POC for customer portal Glossary feature based on
            ...
            <li>
              ...
              digitally innovative improvements to the consumers’ and advisors’
              insurance experience and relationship with the company
            </li>
          </ul>
        </p>
      </div>
      ...
      <div className="card-container">
        ...
        <p>
          <ul>
            ...
            <li>
              Optimized the UX/UI of the website and reduced test case count by{' '}
              <b>70%</b>
            </li>
          </ul>
        </p>
      ...
      <div className="card-container">
        ...
        <p>
          <ul>
            ...
            <li>
              Managed the environment design, maintenance, and quality assurance
